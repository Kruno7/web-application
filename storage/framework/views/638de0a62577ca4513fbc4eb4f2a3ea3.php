                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <?php if(Auth::user()->hasRole('admin')): ?>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="<?php echo e(route('admin.user.index')); ?>">Korisnici</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('admin.city.index')); ?>">Gradovi</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('admin.apartment.index')); ?>">Stanovi</a>
                            </li>
